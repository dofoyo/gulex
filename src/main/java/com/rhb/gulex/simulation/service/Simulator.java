...
public class Simulator {
	...
	public BigDecimal simulate(){
		...
		FileUtil.writeTextFile(dataPath + "simulation/simulate_details.csv", trader.getDetailString(), false);

		FileUtil.writeTextFile(dataPath + "simulation/simulate_profits.csv", trader.getAccountString(), false);
