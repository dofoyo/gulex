...
import com.rhb.gulex.domain.FinancialStatement;
...
public class FinancialStatementServiceImp implements FinancialStatementService {
	...
	public List<OkfinanceStatementDto> getOks() {
		...
		//writeToFile(dataPath+"oks.json", dtos);
		
		return dtos;
	}
	
	
	private void writeToFile(String jsonfile, List<OkfinanceStatementDto> object){
